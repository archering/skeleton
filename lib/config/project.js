...
//        if(o.frame=="angular") str +="#/js/controllers#/js/directives#/js/filters#/js/services";
        ...
        str +="#/src/css/fonts#/html#/src/imgs#/test#/test/spec#/test/report";
        str +="#/src/js/controllers#/src/js/directives#/src/js/filters#/src/js/services#/src/js/lib";        
    }else if(this.type == 1){//standard
        str = "/src#/src/css#/src/css/global#/src/css/modules#/src/css/pages#/src/js";
        str +="#/src/css/fonts#/html#/src/imgs#/test#/test/spec#/test/report";
        if(o.frame=="angular") str +="#/src/js/controllers#/src/js/directives#/src/js/filters#/src/js/services#/src/js/lib";
