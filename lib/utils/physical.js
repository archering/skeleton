   ...
   **/
    ...
    **/
    ...
    function moduleJS(scdata,name,tag){
        var txt = scdata.replace("{{module_name}}",function(){
           return "module."+tag;
        });
        var to = process.cwd()+"/"+ name + "/src/js/"+tag+"/module.js";
        fs.writeFileSync(to,txt,{encoding:"utf8"});   
    };
    ...
    **/
    this.setPlainFile = function(p){
        ...
        copy_template("project/package.json",process.cwd() +"/" + p.name +"/package.json",p);
